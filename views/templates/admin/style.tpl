...
@font-face {
  font-family: Vazir;
  src: url('../modules/kavenegar/font/Vazir.eot');
  src: url('../modules/kavenegar/font/Vazir.eot?#iefix') format('embedded-opentype'),
       url('../modules/kavenegar/font/Vazir.woff') format('woff'),
       url('../modules/kavenegar/font/Vazir.ttf') format('truetype');
  font-weight: normal;
}

@font-face {
  font-family: Vazir;
  src: url('../modules/kavenegar/font/Vazir-Bold.eot');
  src: url('../modules/kavenegar/font/Vazir-Bold.eot?#iefix') format('embedded-opentype'),
       url('../modules/kavenegar/font/Vazir-Bold.woff') format('woff'),
       url('../modules/kavenegar/font/Vazir-Bold.ttf') format('truetype');
  font-weight: bold;
}
